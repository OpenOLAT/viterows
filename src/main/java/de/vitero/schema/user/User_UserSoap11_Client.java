...
public final class User_UserSoap11_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        {
        System.out.println("Invoking getUserListByFields...");
        de.vitero.schema.user.GetUserListByFieldsRequest _getUserListByFields_getUserListByFieldsRequest = null;
        de.vitero.schema.user.Userlist _getUserListByFields__return = port.getUserListByFields(_getUserListByFields_getUserListByFieldsRequest);
        System.out.println("getUserListByFields.result=" + _getUserListByFields__return);
